...
<head>
    ...
    <script type="text/javascript">
		...
		$(document).on("click", "#updateBtn", function(e){
			alert("수정 버튼 클릭함");
			e.preventDefault();
			$("#boardUpdateForm").attr({ "method":"GET", "action":"board_job_update.p"}).submit();
		});
...
<body>
    ...
    <div class="post-form">
        ...
        <form name="boardUpdateForm" id="boardUpdateForm">
            <input type="hidden" name="boardjobid" id="boardjobid" value="<%= _bjvo.getBoardjobid() %>">
            <label for="title">제목</label>
            <input type="text" id="title" name="title" value="<%= _bjvo.getTitle() %>" required>
            
            <label for="content">내용</label>
            <textarea id="content" name="content" rows="10" required><%= _bjvo.getContent() %></textarea>
