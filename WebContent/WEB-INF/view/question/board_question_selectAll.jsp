...
logger.info("boardQuestionSelectAll.jsp >>> : ");
...
Object objPaging = request.getAttribute("pagingBQVO");
BoardQuestionVO pagingBQVO = (BoardQuestionVO)objPaging;	
...
$(document).ready(function() {
    ...
    $(document).on("click", "#insertBtn", function() {
        location.href = "insert_question_form.p";
    });
    ...
    $(document).on("click", "#selectAllBtn", function() {
        $("#boardList").attr({
            "method": "GET",
            "action": "board_question_selectAll.p"
        }).submit();
    });
   ...
   // 수정하기
    $(document).on("click", "#selectBtn", function() {
        ...
        $("#boardList").attr({
            "method": "GET",
            "action": "board_question_select.p"
        }).submit();
    });
    ...
    $(document).on("click", "#contentsBtn", function() {
        ...
        $("#boardList").attr({
            "method": "GET",
            "action": "board_question_selectContents.p"
        }).submit();
    });
    ...
    $(document).on("click", "#deletetBtn", function() {
        ...
        $("#boardList").attr({
            "method": "GET",
            "action": "board_question_delete.p"
        }).submit();
...
<table>	
    ...
    for(int i=0; i<nCnt; i++){		
        BoardQuestionVO _bqvo = list.get(i);
        
        pageSize = Integer.parseInt(pagingBQVO.getPageSize());
    	groupSize = Integer.parseInt(pagingBQVO.getGroupSize());
    	curPage = Integer.parseInt(pagingBQVO.getCurPage());
    	totalCount = Integer.parseInt(_bqvo.getTotalCount());
    %>
    ...
    <td class="left">
    	...
    	<td>
    	<img src="/dogFoot/fileupload/board/<%= _bqvo.getPicturefile() %>" border="1" width="25" height="25" alt="image"><br></td>
        <td class="left">
        <a href="board_question_selectContents.p?boardquestionid=<%= _bqvo.getBoardquestionid() %>"><%= _bqvo.getTitle() %></a>
        </td>
        <td class="left"><%= _bqvo.getUserid() %> </td>	
        <td class="left"><%= _bqvo.getCreateddate() %></td>
        <td class="left"><%= _bqvo.getViewcount() %></td>				
    </tr>	
  ...
  <tr>
		...
		<jsp:include page="board_question_paging.jsp" flush="true">
			<jsp:param name="url" value="board_question_selectAll.p"/>
